    ...
    return (
        <SearchMainComponent>
            <FilterContainer>
                ...
                {menu === cookbooks ? (
                    <CookBooksMenu stateChanged={setStateChanged} setFoodPref={setFoodPref} foodPref={foodPref}/>
                ) : (
            ...
            <ResultsContainer>
                ...
                <InputStyled placeholder="Fresh meat" value={search} onChange={(e) => {
                    setSearch(e.target.value)
                }}/>

                <ResultCardsContainer>
                    {menu === cookbooks && <CookBooks searchValue={search} filters={cookBooksFilters} sortBy={sort}/>}
                    {menu === recipes && <Recipes searchValue={search} filters={recipeFilters} sortBy={sort}/>}
                </ResultCardsContainer>
            </ResultsContainer>
        </SearchMainComponent>
    );
