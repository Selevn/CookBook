  ...
  return (
    <CreateCookBookPage>
      ...
      <TitleContainer>
        ...
        <InputStyled placeholder="Title" value={title} onChange={(e)=>{setTitle(e.target.value)}}/>
      </TitleContainer>
      <TitleContainer>
      ...
      <TitleContainer>
        ...
        <DescriptionInput placeholder="Description" value={desc} onChange={(e)=>{setDesc(e.target.value)}}/>
      </TitleContainer>
      <TitleContainer>
